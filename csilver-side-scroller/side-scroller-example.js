...
function preload() {
  ...
  playerImages = {
    ...
    walkRight: [loadImage("https://i.imgur.com/qM1XrtL.png"), loadImage("https://i.imgur.com/t3jv99x.png"), loadImage("https://i.imgur.com/wqccJTb.png")],
    walkLeft: [loadImage("https://i.imgur.com/XBJQfeI.png"), loadImage("https://i.imgur.com/rmmMdWn.png"), loadImage("https://i.imgur.com/AtcROTZ.png")]
  };
}
...
class Player {
  ...
  show() {
    if (this.state === "stand") {
      image(this.direction === "right" ? playerImages.standRight : playerImages.standLeft, this.x, this.y);
    } else if (this.state === "jump") {
      image(this.direction === "right" ? playerImages.jumpRight : playerImages.jumpLeft, this.x, this.y);
    } else if (this.state === "walk") {
      image(
        this.direction === "right" ? playerImages.walkRight[this.walkFrame] : playerImages.walkLeft[this.walkFrame],
        this.x,
        this.y
      );
    }
